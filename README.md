...
**Include/exclude ASCII-only words**: `--exclude-ascii-only-items` option controls whether ASCII-only items should be included in the output or not. This may help you when you are examining non-ASCII words within multilingual contents.
...
### Requirements
  ...
  * Runtime requirements:
    - Unix-like operating system (Tested mostly on Debian GNU/Linux)
    - libmecab2
    - mecab-ipadic-utf8 or mecab-naist-jdic
  * Build requirements:
    - Unix-like operating system (Tested mostly on Debian GNU/Linux)
    - [Crystal](https://crystal-lang.org)
    - [Shards](https://github.com/crystal-lang/shards) (Dependency manager for Crystal)
...
Many thanks to:
  ...
  * T. Tsunoda (crystal-mecab and crystal-fucoidan author)
